...
python main.py -m -cn cifar10 \
    ...
    num_gpus=0.5 \
    num_cpus=1 \
    dir_tag=cifar10_mutual_dataset_multishot \
...
python main.py -m -cn cifar10 \
    ...
    num_gpus=0.5 \
    num_cpus=1 \
    dir_tag=cifar10_mutual_dataset_singleshot \
    cuda_visible_devices=\"0,1,2,3,4\"
...
python main.py -m -cn emnist \
    ...
    num_gpus=0.5 \
    num_cpus=1 \
    dir_tag=emnist_mutual_dataset_multishot \
    cuda_visible_devices=\"0,1,2,3,4\"
...
python main.py -m -cn emnist \
    ...
    num_gpus=0.5 \
    num_cpus=1 \
    dir_tag=enist_mutual_dataset_singleshot \
    cuda_visible_devices=\"0,1,2,3,4\"
