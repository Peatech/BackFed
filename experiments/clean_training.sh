...
# *CIFAR10
python main.py dataset=cifar10 num_rounds=2000 num_clients=100 model=resnet18 no_attack=True cuda_visible_devices=\"1,2,3,4,5\" num_gpus=0.5 save_checkpoint=True "save_model_rounds=[200,400,600,800,1000,1200,1400,1600,1800,2000]" checkpoint=Null
