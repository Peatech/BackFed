...
# *FEMNIST
python main.py -cn femnist model=mnistnet num_clients_per_round=30 num_rounds=2000 no_attack=True cuda_visible_devices=\"1,5,7,2,4\" "save_model_rounds=[200,400,600,800,1000,1200,1400,1600,1800,2000]" test_batch_size=5000 test_every=5 num_workers=8 save_checkpoint=True checkpoint=Null dir_tag=clean_training
...
python main.py -cn femnist model=mnistnet num_clients_per_round=30 num_rounds=1000 no_attack=True cuda_visible_devices=\"1,5,7,2,4\" "save_model_rounds=[200,400,600,800,1000,1200,1400,1600,1800,2000]" test_batch_size=5000 test_every=5 num_workers=8 save_checkpoint=True checkpoint=Null dir_tag=clean_training && \
